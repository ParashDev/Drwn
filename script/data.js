...
const TEMPLATES = [
  ...
  // ── 21. Reels — Happy Birthday ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 90, y: 620, w: 900, h: 220, text: 'Happy\nBirthday!', fill: 'transparent',
  ...
  // ── 22. Reels — Anniversary ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 140, y: 500, w: 800, h: 82, text: 'Celebrating', fill: 'transparent',
  ...
  // ── 26. Reels — Valentine's Day ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 100, y: 700, w: 880, h: 178, text: 'Happy\nValentine\u2019s Day', fill: 'transparent',
  ...
  // ── 27. Reels — Eid Mubarak ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 140, y: 550, w: 800, h: 106, text: 'Eid Mubarak', fill: 'transparent',
      ...
      { type: 'text', x: 140, y: 710, w: 800, h: 112, text: 'May this blessed occasion bring\npeace, happiness, and prosperity\nto you and your family', fill: 'transparent',
      ...
      { type: 'text', x: 200, y: 880, w: 680, h: 30, text: 'FROM OUR FAMILY TO YOURS', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#C9A96E', textAlign: 'center', letterSpacing: 4, name: 'From' },
  ...
  // ── 28. Reels — Christmas ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 100, y: 800, w: 880, h: 184, text: 'Merry\nChristmas', fill: 'transparent',
      ...
      { type: 'text', x: 200, y: 1140, w: 680, h: 30, text: 'WITH LOVE FROM OUR FAMILY', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#C0392B', textAlign: 'center', letterSpacing: 3, name: 'From' },
    ]
  },
  ...
  // ── 30. Reels — Engagement ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 140, y: 480, w: 800, h: 70, text: 'We Said', fill: 'transparent',
      ...
      { type: 'text', x: 200, y: 1650, w: 680, h: 26, text: '#ENGAGED \u2022 SPRING 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '500', textColor: '#B76E79', textAlign: 'center', letterSpacing: 3, name: 'Hashtag' },
    ]
  },
  // ── 31. Reels — Motivational Quote ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 100, y: 520, w: 880, h: 472, text: 'STOP\nWAITING.\nSTART\nCREATING.', fill: 'transparent',
  ...
  // ── 32. Reels — Product Showcase ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 90, y: 1020, w: 900, h: 176, text: 'The Classic\nCollection', fill: 'transparent',
      ...
      { type: 'text', x: 90, y: 1380, w: 400, h: 78, text: '$199', fill: 'transparent',
  ...
  // ── 33. Reels — Fitness Workout ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 250, w: 920, h: 250, text: 'FULL BODY\nBURN', fill: 'transparent',
  ...
  // ── 35. Reels — Travel Destination ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 1120, w: 920, h: 50, text: 'GREECE', fill: 'transparent',
  ...
  // ── 37. Reels — Flash Sale ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 80, w: 920, h: 212, text: 'FLASH\nSALE', fill: 'transparent',
      ...
      { type: 'text', x: 180, y: 810, w: 200, h: 112, text: '06', fill: 'transparent',
      ...
      { type: 'text', x: 180, y: 900, w: 200, h: 26, text: 'HOURS', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#888888', textAlign: 'center', letterSpacing: 3, name: 'H Label' },
      { type: 'rect', x: 440, y: 800, w: 200, h: 140, fill: '#111111', borderRadius: 16, name: 'Min Box' },
      { type: 'text', x: 440, y: 810, w: 200, h: 112, text: '24', fill: 'transparent',
      ...
      { type: 'text', x: 440, y: 900, w: 200, h: 26, text: 'MINUTES', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#888888', textAlign: 'center', letterSpacing: 3, name: 'M Label' },
      { type: 'rect', x: 700, y: 800, w: 200, h: 140, fill: '#111111', borderRadius: 16, name: 'Sec Box' },
      { type: 'text', x: 700, y: 810, w: 200, h: 112, text: '59', fill: 'transparent',
      ...
      { type: 'text', x: 700, y: 900, w: 200, h: 26, text: 'SECONDS', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#888888', textAlign: 'center', letterSpacing: 3, name: 'S Label' },
  ...
  // ── 38. Reels — Coming Soon ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 670, w: 920, h: 242, text: 'COMING\nSOON', fill: 'transparent',
  ...
  // ── 39. Reels — Tips & Tricks ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 155, w: 120, h: 100, text: '5', fill: 'transparent',
  ...
  // ── 40. Reels — Before & After ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 50, w: 920, h: 138, text: 'THE\nTRANSFORMATION', fill: 'transparent',
  ...
  // ── 41. Reels — Portfolio Showcase ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 980, w: 920, h: 140, text: 'Brand Identity\nRedesign', fill: 'transparent',
      ...
      { type: 'text', x: 80, y: 1350, w: 300, h: 30, text: 'CLIENT', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#999999', letterSpacing: 4, name: 'Client Label' },
      ...
      { type: 'text', x: 500, y: 1350, w: 300, h: 30, text: 'YEAR', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#999999', letterSpacing: 4, name: 'Year Label' },
  ...
  // ── 42. Reels — Book Recommendation ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 890, w: 920, h: 168, text: 'Atomic\nHabits', fill: 'transparent',
  ...
  // ── 43. Reels — Morning Routine ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 220, w: 920, h: 176, text: 'Morning\nRoutine', fill: 'transparent',
  ...
  // ── 44. Reels — DIY Tutorial ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 200, w: 920, h: 148, text: 'Macram\u00E9\nWall Hanging', fill: 'transparent',
  ...
  // ── 45. Reels — Coffee / Caf\u00E9 ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 870, w: 920, h: 186, text: 'Morning\nEspresso', fill: 'transparent',
      ...
      { type: 'text', x: 250, y: 1290, w: 260, h: 40, text: 'SMALL', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#D4874E', textAlign: 'center', letterSpacing: 3, name: 'Size 1' },
      ...
      { type: 'text', x: 570, y: 1290, w: 260, h: 40, text: 'LARGE', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#2C1810', textAlign: 'center', letterSpacing: 3, name: 'Size 2' },
  ...
  // ── 46. Reels — Fashion Outfit ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 1160, w: 920, h: 158, text: 'Effortless\nElegance', fill: 'transparent',
      ...
      { type: 'text', x: 80, y: 1350, w: 460, h: 30, text: 'TOP', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#999999', letterSpacing: 3, name: 'Item 1 Label' },
      { type: 'text', x: 80, y: 1380, w: 460, h: 38, text: 'Silk blouse — Zara', fill: 'transparent',
      ...
      { type: 'text', x: 560, y: 1350, w: 440, h: 30, text: 'BOTTOM', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#999999', letterSpacing: 3, name: 'Item 2 Label' },
      { type: 'text', x: 560, y: 1380, w: 440, h: 38, text: 'Tailored trousers — H&M', fill: 'transparent',
      ...
      { type: 'text', x: 80, y: 1450, w: 460, h: 30, text: 'SHOES', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#999999', letterSpacing: 3, name: 'Item 3 Label' },
      { type: 'text', x: 80, y: 1480, w: 460, h: 38, text: 'Leather loafers — Mango', fill: 'transparent',
      ...
      { type: 'text', x: 560, y: 1450, w: 440, h: 30, text: 'BAG', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '600', textColor: '#999999', letterSpacing: 3, name: 'Item 4 Label' },
      { type: 'text', x: 560, y: 1480, w: 440, h: 38, text: 'Mini crossbody — COS', fill: 'transparent',
  ...
  // ── 47. Reels — Tech Review ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 930, w: 920, h: 152, text: 'iPhone 17\nPro Max', fill: 'transparent',
  ...
  // ── 48. Reels — Meditation / Wellness ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 840, w: 920, h: 176, text: 'Find Your\nInner Peace', fill: 'transparent',
  ...
  // ── 49. Reels — Pet Feature ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 810, w: 920, h: 136, text: 'BUDDY', fill: 'transparent',
        fontFamily: 'Poppins', fontSize: 90, fontWeight: '700', textColor: '#2D2D2D', textAlign: 'center', name: 'Pet Name' },
      { type: 'text', x: 200, y: 930, w: 680, h: 44, text: 'Golden Retriever \u2022 3 years old', fill: 'transparent',
  ...
  // ── 50. Reels — Event Countdown ──
  {
    ...
    elements: [
      ...
      { type: 'text', x: 80, y: 330, w: 920, h: 370, text: 'DESIGN\nCONF\n2026', fill: 'transparent',
      ...
      { type: 'text', x: 130, y: 680, w: 240, h: 120, text: '15', fill: 'transparent',
      ...
      { type: 'text', x: 420, y: 680, w: 240, h: 120, text: '08', fill: 'transparent',
      ...
      { type: 'text', x: 710, y: 680, w: 240, h: 120, text: '42', fill: 'transparent',
  ...
  // ── Image Stack Templates (3 portrait photos, full-canvas, text woven around) ──

  // Style 1: Cascade Reveal — diagonal cascade, top-left to bottom-right
  {
    id: 'tpl_51', name: 'Cascade Reveal', category: 'Instagram Reels',
    description: 'Three portrait photos cascading diagonally across the full canvas',
    canvasW: 1080, canvasH: 1920, bgColor: '#F5F0EB',
    previewColors: ['#F5F0EB','#C9B8A8','#2C2C2C'],
    elements: [
      { type: 'rect', x: 0, y: 0, w: 700, h: 920, fill: '#C9B8A8', name: 'Photo 1' },
      { type: 'rect', x: 200, y: 520, w: 680, h: 880, fill: '#BFB0A0', name: 'Photo 2' },
      { type: 'rect', x: 380, y: 1060, w: 700, h: 860, fill: '#D0C4B6', name: 'Photo 3' },
      { type: 'text', x: 720, y: 40, w: 340, h: 36, text: '2026 COLLECTION', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 18, fontWeight: '500', textColor: '#8C7E70',
        textAlign: 'left', letterSpacing: 5, name: 'Tag' },
      { type: 'text', x: 610, y: 148, w: 500, h: 78, text: 'TIMELESS', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 50, fontWeight: '700', textColor: '#2C2C2C',
        textAlign: 'center', letterSpacing: 8, rotation: -90, name: 'Headline' },
      { type: 'line', x: 60, y: 1440, w: 140, h: 2, fill: '#C4704B', name: 'Accent' },
      { type: 'text', x: 60, y: 1460, w: 300, h: 50, text: 'a visual narrative', fill: 'transparent',
        fontFamily: 'Lora', fontSize: 24, fontWeight: '400', textColor: '#5C5048',
        textAlign: 'left', italic: true, name: 'Subtitle' },
    ]
  },

  // Style 2: The Interleave — anchor photo + headline band + staggered pair
  {
    id: 'tpl_52', name: 'The Interleave', category: 'Instagram Reels',
    description: 'Large anchor photo with full-width headline and staggered pair below',
    canvasW: 1080, canvasH: 1920, bgColor: '#FFFFFF',
    previewColors: ['#FFFFFF','#C9B8A8','#1A1A1A'],
    elements: [
      { type: 'rect', x: 80, y: 40, w: 920, h: 840, fill: '#C9B8A8', name: 'Photo 1' },
      { type: 'text', x: 40, y: 50, w: 200, h: 30, text: 'MARCH 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '500', textColor: '#999999',
        textAlign: 'left', letterSpacing: 5, name: 'Date' },
      { type: 'line', x: 0, y: 920, w: 1080, h: 1, fill: '#A8B5A0', name: 'Rule Top' },
      { type: 'text', x: 0, y: 940, w: 1080, h: 90, text: 'THE QUIET DAYS', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 56, fontWeight: '400', textColor: '#1A1A1A',
        textAlign: 'center', italic: true, name: 'Headline' },
      { type: 'line', x: 0, y: 1040, w: 1080, h: 1, fill: '#A8B5A0', name: 'Rule Bottom' },
      { type: 'rect', x: 0, y: 1080, w: 460, h: 780, fill: '#BFB0A0', name: 'Photo 2' },
      { type: 'rect', x: 620, y: 1100, w: 460, h: 820, fill: '#D0C4B6', name: 'Photo 3' },
      { type: 'text', x: 210, y: 1220, w: 660, h: 34, text: 'stories worth telling', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '400', textColor: '#CCCCCC',
        textAlign: 'center', letterSpacing: 3, rotation: -90, name: 'Spine' },
    ]
  },

  // Style 3: Overlap Tapestry — exhibition poster, aggressive overlaps
  {
    id: 'tpl_53', name: 'Overlap Tapestry', category: 'Instagram Reels',
    description: 'Three large overlapping portrait photos with text weaving through',
    canvasW: 1080, canvasH: 1920, bgColor: '#E8E4E0',
    previewColors: ['#E8E4E0','#C9B8A8','#2A2118'],
    elements: [
      { type: 'text', x: 60, y: 40, w: 960, h: 106, text: 'APERTURE', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 68, fontWeight: '400', textColor: '#2A2118',
        textAlign: 'center', italic: true, letterSpacing: 8, name: 'Headline' },
      { type: 'line', x: 400, y: 145, w: 280, h: 1, fill: '#B8A898', name: 'Rule' },
      { type: 'rect', x: 0, y: 180, w: 660, h: 960, fill: '#C9B8A8', name: 'Photo 1' },
      { type: 'rect', x: 380, y: 340, w: 700, h: 940, fill: '#B8ADA0', name: 'Photo 2' },
      { type: 'rect', x: 0, y: 780, w: 1080, h: 56, fill: '#2A2118', opacity: 55, name: 'Text Band BG' },
      { type: 'text', x: 60, y: 788, w: 960, h: 40, text: 'WHERE LIGHT MEETS SHADOW', fill: 'transparent',
        fontFamily: 'Montserrat', fontSize: 18, fontWeight: '600', textColor: '#F0E8DA',
        textAlign: 'center', letterSpacing: 10, name: 'Band Text' },
      { type: 'rect', x: 100, y: 1000, w: 640, h: 920, fill: '#D0C4B6', name: 'Photo 3' },
      { type: 'text', x: 760, y: 1400, w: 280, h: 180,
        text: 'A curated exploration of form, texture, and the spaces between.', fill: 'transparent',
        fontFamily: 'Lora', fontSize: 18, fontWeight: '400', textColor: '#5C5048',
        textAlign: 'left', lineHeight: 1.7, name: 'Body' },
      { type: 'text', x: 760, y: 1856, w: 280, h: 30, text: '#VISUALDIARY', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '400', textColor: '#B8908A',
        textAlign: 'left', letterSpacing: 6, name: 'Tag' },
    ]
  },

  // Style 4: Split Spine — luxury dark, two photos flanking center, bridge at bottom
  {
    id: 'tpl_54', name: 'Split Spine', category: 'Instagram Reels',
    description: 'Two photos flanking a gold center spine with bridge photo below',
    canvasW: 1080, canvasH: 1920, bgColor: '#1E1E1E',
    previewColors: ['#1E1E1E','#3A3530','#C9A96E'],
    elements: [
      { type: 'line', x: 538, y: 0, w: 4, h: 1920, fill: '#C9A96E', opacity: 30, name: 'Spine Line' },
      { type: 'text', x: 0, y: 40, w: 520, h: 82, text: 'ETERNAL', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 52, fontWeight: '700', textColor: '#F0E8DA',
        textAlign: 'right', letterSpacing: 6, name: 'Title Left' },
      { type: 'text', x: 560, y: 40, w: 520, h: 82, text: 'BEAUTY', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 52, fontWeight: '700', textColor: '#F0E8DA',
        textAlign: 'left', letterSpacing: 6, name: 'Title Right' },
      { type: 'rect', x: 0, y: 140, w: 500, h: 860, fill: '#3A3530', name: 'Photo 1' },
      { type: 'rect', x: 580, y: 280, w: 500, h: 860, fill: '#302C28', name: 'Photo 2' },
      { type: 'text', x: 190, y: 630, w: 700, h: 28,
        text: 'where timeless elegance finds its form', fill: 'transparent',
        fontFamily: 'JetBrains Mono', fontSize: 14, fontWeight: '300', textColor: '#666655',
        textAlign: 'center', letterSpacing: 2, rotation: -90, name: 'Spine Text' },
      { type: 'text', x: 200, y: 1178, w: 680, h: 34, text: 'EST. 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '400', textColor: '#C9A96E',
        textAlign: 'center', letterSpacing: 8, name: 'Tagline' },
      { type: 'rect', x: 160, y: 1240, w: 560, h: 680, fill: '#353028', name: 'Photo 3' },
    ]
  },

  // Style 5: Scattered Frames — zigzag gallery frames filling the canvas
  {
    id: 'tpl_55', name: 'Scattered Frames', category: 'Instagram Reels',
    description: 'Three large framed portrait photos in zigzag with handwritten notes',
    canvasW: 1080, canvasH: 1920, bgColor: '#FAF6F1',
    previewColors: ['#FAF6F1','#FFFFFF','#3D3028'],
    elements: [
      { type: 'text', x: -750, y: 910, w: 1600, h: 100, text: 'SNAPSHOTS', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 100, fontWeight: '400', textColor: '#EDE6DE',
        textAlign: 'center', rotation: -90, name: 'Watermark' },
      { type: 'rect', x: 40, y: 20, w: 620, h: 760, fill: '#FFFFFF',
        shadowX: 0, shadowY: 4, shadowBlur: 24, shadowColor: '#000000', shadowOpacity: 8, name: 'Frame 1' },
      { type: 'rect', x: 64, y: 44, w: 572, h: 600, fill: '#C9B8A8', name: 'Photo 1' },
      { type: 'text', x: 64, y: 666, w: 572, h: 44, text: 'the beginning', fill: 'transparent',
        fontFamily: 'Caveat', fontSize: 28, fontWeight: '400', textColor: '#7A6E63',
        textAlign: 'center', name: 'Caption 1' },
      { type: 'rect', x: 380, y: 560, w: 660, h: 800, fill: '#FFFFFF',
        shadowX: 0, shadowY: 4, shadowBlur: 24, shadowColor: '#000000', shadowOpacity: 8, name: 'Frame 2' },
      { type: 'rect', x: 404, y: 584, w: 612, h: 640, fill: '#BFB0A0', name: 'Photo 2' },
      { type: 'rect', x: 40, y: 1120, w: 640, h: 800, fill: '#FFFFFF',
        shadowX: 0, shadowY: 4, shadowBlur: 24, shadowColor: '#000000', shadowOpacity: 8, name: 'Frame 3' },
      { type: 'rect', x: 64, y: 1144, w: 592, h: 640, fill: '#D0C4B6', name: 'Photo 3' },
      { type: 'text', x: 404, y: 1246, w: 612, h: 44, text: 'golden hour', fill: 'transparent',
        fontFamily: 'Caveat', fontSize: 28, fontWeight: '400', textColor: '#7A6E63',
        textAlign: 'center', name: 'Caption 2' },
      { type: 'text', x: 64, y: 1806, w: 592, h: 44, text: 'still here', fill: 'transparent',
        fontFamily: 'Caveat', fontSize: 28, fontWeight: '400', textColor: '#7A6E63',
        textAlign: 'center', name: 'Caption 3' },
      { type: 'text', x: 40, y: 820, w: 320, h: 140,
        text: 'Every photograph is a story waiting to unfold.', fill: 'transparent',
        fontFamily: 'Lora', fontSize: 20, fontWeight: '400', textColor: '#5C5048',
        textAlign: 'left', lineHeight: 1.7, italic: true, name: 'Note' },
      { type: 'line', x: 720, y: 1480, w: 140, h: 1, fill: '#C4704B', name: 'Accent' },
      { type: 'text', x: 720, y: 1500, w: 320, h: 36, text: 'JOURNAL', fill: 'transparent',
        fontFamily: 'Montserrat', fontSize: 18, fontWeight: '600', textColor: '#3D3028',
        textAlign: 'left', letterSpacing: 10, name: 'Title' },
    ]
  },

  // Style 6: Corner Pin — photos pinned to three corners, text in the fourth
  {
    id: 'tpl_56', name: 'Corner Pin', category: 'Instagram Reels',
    description: 'Three portrait photos pinned to corners with text in the open corner',
    canvasW: 1080, canvasH: 1920, bgColor: '#1A1A2E',
    previewColors: ['#1A1A2E','#2D2D4A','#E0A870'],
    elements: [
      { type: 'rect', x: 0, y: 0, w: 540, h: 780, fill: '#2D2D4A', name: 'Photo 1' },
      { type: 'rect', x: 560, y: 0, w: 520, h: 720, fill: '#3A3A58', name: 'Photo 2' },
      { type: 'rect', x: 0, y: 800, w: 560, h: 820, fill: '#252542', name: 'Photo 3' },
      { type: 'line', x: 600, y: 860, w: 420, h: 2, fill: '#E0A870', name: 'Accent' },
      { type: 'text', x: 600, y: 890, w: 440, h: 160, text: 'AFTER\nDARK', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 72, fontWeight: '400', textColor: '#FFFFFF',
        textAlign: 'left', lineHeight: 1.0, name: 'Headline' },
      { type: 'text', x: 600, y: 1070, w: 420, h: 120,
        text: 'Exploring the world between dusk and dawn.', fill: 'transparent',
        fontFamily: 'Lora', fontSize: 20, fontWeight: '400', textColor: '#8888AA',
        textAlign: 'left', lineHeight: 1.7, italic: true, name: 'Body' },
      { type: 'text', x: 600, y: 1220, w: 420, h: 30, text: '@NIGHTFRAMES', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '500', textColor: '#E0A870',
        textAlign: 'left', letterSpacing: 5, name: 'Handle' },
      { type: 'rect', x: 340, y: 1380, w: 740, h: 540, fill: '#2D2D4A', opacity: 40, name: 'Fade Rect' },
      { type: 'text', x: 0, y: 1872, w: 1080, h: 30, text: 'VOL. 03  \u2022  NOCTURNAL SERIES', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '400', textColor: '#555570',
        textAlign: 'center', letterSpacing: 6, name: 'Footer' },
    ]
  },

  // Style 7: Vertical Ladder — three photos stepping down like a ladder
  {
    id: 'tpl_57', name: 'Vertical Ladder', category: 'Instagram Reels',
    description: 'Three portrait photos stepping down with text alongside each',
    canvasW: 1080, canvasH: 1920, bgColor: '#F8F4F0',
    previewColors: ['#F8F4F0','#D6C8B8','#2C2C2C'],
    elements: [
      { type: 'rect', x: 0, y: 0, w: 680, h: 660, fill: '#C9B8A8', name: 'Photo 1' },
      { type: 'text', x: 720, y: 200, w: 320, h: 40, text: 'CHAPTER', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '600', textColor: '#A09080',
        textAlign: 'left', letterSpacing: 6, name: 'Label 1' },
      { type: 'text', x: 720, y: 250, w: 320, h: 100, text: 'ONE', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 64, fontWeight: '700', textColor: '#2C2C2C',
        textAlign: 'left', name: 'Num 1' },
      { type: 'rect', x: 200, y: 680, w: 680, h: 660, fill: '#BFB0A0', name: 'Photo 2' },
      { type: 'text', x: 0, y: 860, w: 180, h: 40, text: 'CHAPTER', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '600', textColor: '#A09080',
        textAlign: 'right', letterSpacing: 6, name: 'Label 2' },
      { type: 'text', x: 0, y: 910, w: 180, h: 100, text: 'TWO', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 64, fontWeight: '700', textColor: '#2C2C2C',
        textAlign: 'right', name: 'Num 2' },
      { type: 'rect', x: 400, y: 1360, w: 680, h: 560, fill: '#D0C4B6', name: 'Photo 3' },
      { type: 'text', x: 40, y: 1500, w: 340, h: 40, text: 'CHAPTER', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '600', textColor: '#A09080',
        textAlign: 'left', letterSpacing: 6, name: 'Label 3' },
      { type: 'text', x: 40, y: 1550, w: 340, h: 100, text: 'THREE', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 64, fontWeight: '700', textColor: '#2C2C2C',
        textAlign: 'left', name: 'Num 3' },
    ]
  },

  // Style 8: Bold Overlap — dark moody, big serif text splitting photos apart
  {
    id: 'tpl_58', name: 'Bold Overlap', category: 'Instagram Reels',
    description: 'Three overlapping photos with large serif text slicing between them',
    canvasW: 1080, canvasH: 1920, bgColor: '#111111',
    previewColors: ['#111111','#2A2A2A','#FFFFFF'],
    elements: [
      { type: 'rect', x: 0, y: 0, w: 620, h: 840, fill: '#2A2A2A', name: 'Photo 1' },
      { type: 'rect', x: 460, y: 580, w: 620, h: 840, fill: '#333333', name: 'Photo 2' },
      { type: 'rect', x: 140, y: 1180, w: 660, h: 740, fill: '#252525', name: 'Photo 3' },
      { type: 'text', x: 40, y: 720, w: 1000, h: 160, text: 'LOOK', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 140, fontWeight: '700', textColor: '#FFFFFF',
        textAlign: 'left', lineHeight: 1.0, name: 'Title 1' },
      { type: 'text', x: 40, y: 1300, w: 1000, h: 160, text: 'CLOSER', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 140, fontWeight: '700', textColor: '#FFFFFF',
        textAlign: 'right', lineHeight: 1.0, name: 'Title 2' },
      { type: 'line', x: 40, y: 1780, w: 200, h: 1, fill: '#444444', name: 'Rule' },
      { type: 'text', x: 40, y: 1800, w: 500, h: 34, text: 'A STUDY IN PERSPECTIVE', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '400', textColor: '#666666',
        textAlign: 'left', letterSpacing: 6, name: 'Subtitle' },
      { type: 'text', x: 700, y: 1800, w: 340, h: 44, text: '2026', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 24, fontWeight: '400', textColor: '#444444',
        textAlign: 'right', name: 'Year' },
    ]
  },

  // Style 9: Editorial Grid — structured asymmetric with generous text columns
  {
    id: 'tpl_59', name: 'Editorial Grid', category: 'Instagram Reels',
    description: 'Structured asymmetric layout with photos and text columns',
    canvasW: 1080, canvasH: 1920, bgColor: '#FAFAF8',
    previewColors: ['#FAFAF8','#C4B5A0','#1A1A1A'],
    elements: [
      { type: 'text', x: 60, y: 50, w: 960, h: 34, text: 'FEATURE  \u2022  SPRING 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '500', textColor: '#A09080',
        textAlign: 'center', letterSpacing: 6, name: 'Header' },
      { type: 'line', x: 60, y: 100, w: 960, h: 1, fill: '#D4C5B0', name: 'Rule Top' },
      { type: 'rect', x: 0, y: 120, w: 680, h: 900, fill: '#C9B8A8', name: 'Photo 1' },
      { type: 'text', x: 720, y: 160, w: 320, h: 120, text: 'THE\nESSENCE', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 42, fontWeight: '700', textColor: '#1A1A1A',
        textAlign: 'left', lineHeight: 1.2, name: 'Headline' },
      { type: 'line', x: 720, y: 300, w: 120, h: 2, fill: '#C4704B', name: 'Accent' },
      { type: 'text', x: 720, y: 330, w: 320, h: 280,
        text: 'Capturing the raw beauty of fleeting moments through a lens of stillness and intention.', fill: 'transparent',
        fontFamily: 'Lora', fontSize: 18, fontWeight: '400', textColor: '#5C5048',
        textAlign: 'left', lineHeight: 1.7, name: 'Body' },
      { type: 'rect', x: 0, y: 1040, w: 500, h: 700, fill: '#BFB0A0', name: 'Photo 2' },
      { type: 'rect', x: 520, y: 1060, w: 560, h: 860, fill: '#D0C4B6', name: 'Photo 3' },
      { type: 'text', x: 60, y: 1780, w: 400, h: 34, text: 'CONTINUED \u2192', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 16, fontWeight: '600', textColor: '#A09080',
        textAlign: 'left', letterSpacing: 4, name: 'CTA' },
      { type: 'line', x: 60, y: 1840, w: 960, h: 1, fill: '#D4C5B0', name: 'Rule Bottom' },
      { type: 'text', x: 60, y: 1860, w: 960, h: 30, text: 'PAGE 01 OF 04', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '400', textColor: '#BBBBBB',
        textAlign: 'center', letterSpacing: 6, name: 'Page' },
    ]
  },

  // Style 10: Full Bleed Stack — photos bleed edge-to-edge with text overlays
  {
    id: 'tpl_60', name: 'Full Bleed Stack', category: 'Instagram Reels',
    description: 'Three edge-to-edge portrait photos stacked with text overlays',
    canvasW: 1080, canvasH: 1920, bgColor: '#000000',
    previewColors: ['#000000','#1A1A1A','#FFFFFF'],
    elements: [
      { type: 'rect', x: 0, y: 0, w: 1080, h: 680, fill: '#2A2A2A', name: 'Photo 1' },
      { type: 'line', x: 0, y: 690, w: 1080, h: 6, fill: '#000000', name: 'Gap 1' },
      { type: 'rect', x: 0, y: 700, w: 1080, h: 620, fill: '#333333', name: 'Photo 2' },
      { type: 'line', x: 0, y: 1330, w: 1080, h: 6, fill: '#000000', name: 'Gap 2' },
      { type: 'rect', x: 0, y: 1340, w: 1080, h: 580, fill: '#252525', name: 'Photo 3' },
      { type: 'text', x: 60, y: 560, w: 500, h: 100, text: 'WANDER', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 64, fontWeight: '400', textColor: '#FFFFFF',
        textAlign: 'left', letterSpacing: 4, opacity: 85, name: 'Overlay 1' },
      { type: 'text', x: 580, y: 1180, w: 460, h: 100, text: 'FURTHER', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 64, fontWeight: '400', textColor: '#FFFFFF',
        textAlign: 'right', letterSpacing: 4, opacity: 85, name: 'Overlay 2' },
      { type: 'text', x: 60, y: 1780, w: 500, h: 100, text: 'ALWAYS', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 64, fontWeight: '400', textColor: '#FFFFFF',
        textAlign: 'left', letterSpacing: 4, opacity: 85, name: 'Overlay 3' },
      { type: 'line', x: 460, y: 1865, w: 160, h: 1, fill: '#555555', name: 'Center Rule' },
      { type: 'text', x: 0, y: 1876, w: 1080, h: 30, text: 'A VISUAL JOURNEY', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 14, fontWeight: '500', textColor: '#666666',
        textAlign: 'center', letterSpacing: 8, name: 'Footer' },
    ]
  },
