...
const TEMPLATES = [
  ...
  // Style 1: Cascade Reveal — diagonal cascade, top-left to bottom-right
  {
    ...
    elements: [
      ...
      { type: 'text', x: 720, y: 40, w: 340, h: 24, text: '2026 COLLECTION', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 11, fontWeight: '500', textColor: '#8C7E70',
        textAlign: 'left', letterSpacing: 5, name: 'Tag' },
      { type: 'text', x: 610, y: 148, w: 500, h: 55, text: 'TIMELESS', fill: 'transparent',
  ...
  // Style 2: The Interleave — anchor photo + headline band + staggered pair
  {
    ...
    elements: [
      { type: 'text', x: 40, y: 50, w: 120, h: 20, text: 'MARCH 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 10, fontWeight: '500', textColor: '#999999',
      ...
      { type: 'text', x: 0, y: 940, w: 1080, h: 80, text: 'THE QUIET DAYS', fill: 'transparent',
      ...
      { type: 'text', x: 210, y: 1220, w: 660, h: 28, text: 'stories worth telling', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 12, fontWeight: '400', textColor: '#CCCCCC',
  ...
  // Style 3: Overlap Tapestry — exhibition poster, aggressive overlaps
  {
    ...
    elements: [
      { type: 'text', x: 60, y: 40, w: 960, h: 90, text: 'APERTURE', fill: 'transparent',
      ...
      { type: 'text', x: 60, y: 790, w: 960, h: 36, text: 'WHERE LIGHT MEETS SHADOW', fill: 'transparent',
        fontFamily: 'Montserrat', fontSize: 15, fontWeight: '600', textColor: '#F0E8DA',
      ...
      { type: 'text', x: 760, y: 1860, w: 280, h: 24, text: '#VISUALDIARY', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 11, fontWeight: '400', textColor: '#B8908A',
  ...
  // Style 4: Split Spine — luxury dark, two photos flanking center, bridge at bottom
  {
    ...
    elements: [
      ...
      { type: 'text', x: 0, y: 40, w: 520, h: 70, text: 'ETERNAL', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 52, fontWeight: '700', textColor: '#F0E8DA',
        textAlign: 'right', letterSpacing: 6, name: 'Title Left' },
      { type: 'text', x: 560, y: 40, w: 520, h: 70, text: 'BEAUTY', fill: 'transparent',
        fontFamily: 'Playfair Display', fontSize: 52, fontWeight: '700', textColor: '#F0E8DA',
      ...
      { type: 'text', x: 190, y: 630, w: 700, h: 22,
        text: 'where timeless elegance finds its form', fill: 'transparent',
        fontFamily: 'JetBrains Mono', fontSize: 9, fontWeight: '300', textColor: '#666655',
        textAlign: 'center', letterSpacing: 2, rotation: -90, name: 'Spine Text' },
      { type: 'text', x: 200, y: 1180, w: 680, h: 30, text: 'EST. 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 12, fontWeight: '400', textColor: '#C9A96E',
  ...
  // Style 5: Scattered Frames — zigzag gallery frames filling the canvas
  {
    ...
    elements: [
      ...
      { type: 'text', x: 720, y: 1500, w: 320, h: 36, text: 'JOURNAL', fill: 'transparent',
        fontFamily: 'Montserrat', fontSize: 14, fontWeight: '600', textColor: '#3D3028',
  ...
  // Style 6: Corner Pin — photos pinned to three corners, text in the fourth
  {
    ...
    elements: [
      ...
      { type: 'text', x: 600, y: 1200, w: 420, h: 24, text: '@NIGHTFRAMES', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 11, fontWeight: '500', textColor: '#E0A870',
        textAlign: 'left', letterSpacing: 5, name: 'Handle' },
      { type: 'rect', x: 340, y: 1380, w: 740, h: 540, fill: '#2D2D4A', opacity: 40, name: 'Fade Rect' },
      { type: 'text', x: 0, y: 1880, w: 1080, h: 20, text: 'VOL. 03  \u2022  NOCTURNAL SERIES', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 10, fontWeight: '400', textColor: '#555570',
  ...
  // Style 7: Vertical Ladder — three photos stepping down like a ladder
  {
    ...
    elements: [
      ...
      { type: 'text', x: 720, y: 200, w: 320, h: 40, text: 'CHAPTER', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 11, fontWeight: '600', textColor: '#A09080',
  ...
  // Style 8: Bold Overlap — dark moody, big serif text splitting photos apart
  {
    ...
    elements: [
      ...
      { type: 'text', x: 40, y: 1800, w: 500, h: 30, text: 'A STUDY IN PERSPECTIVE', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 12, fontWeight: '400', textColor: '#666666',
        textAlign: 'left', letterSpacing: 6, name: 'Subtitle' },
      { type: 'text', x: 700, y: 1800, w: 340, h: 30, text: '2026', fill: 'transparent',
  ...
  // Style 9: Editorial Grid — structured asymmetric with generous text columns
  {
    ...
    elements: [
      { type: 'text', x: 60, y: 50, w: 960, h: 30, text: 'FEATURE  \u2022  SPRING 2026', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 11, fontWeight: '500', textColor: '#A09080',
      ...
      { type: 'text', x: 60, y: 1780, w: 400, h: 30, text: 'CONTINUED \u2192', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 12, fontWeight: '600', textColor: '#A09080',
      ...
      { type: 'text', x: 60, y: 1860, w: 960, h: 30, text: 'PAGE 01 OF 04', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 10, fontWeight: '400', textColor: '#BBBBBB',
  ...
  // Style 10: Full Bleed Stack — photos bleed edge-to-edge with text overlays
  {
    ...
    elements: [
      ...
      { type: 'text', x: 60, y: 560, w: 500, h: 80, text: 'WANDER', fill: 'transparent',
      ...
      { type: 'text', x: 580, y: 1180, w: 460, h: 80, text: 'FURTHER', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 64, fontWeight: '400', textColor: '#FFFFFF',
      ...
      { type: 'text', x: 60, y: 1780, w: 500, h: 80, text: 'ALWAYS', fill: 'transparent',
        fontFamily: 'Bebas Neue', fontSize: 64, fontWeight: '400', textColor: '#FFFFFF',
        textAlign: 'left', letterSpacing: 4, opacity: 85, name: 'Overlay 3' },
      { type: 'line', x: 460, y: 1865, w: 160, h: 1, fill: '#555555', name: 'Center Rule' },
      { type: 'text', x: 0, y: 1880, w: 1080, h: 24, text: 'A VISUAL JOURNEY', fill: 'transparent',
        fontFamily: 'DM Sans', fontSize: 10, fontWeight: '500', textColor: '#666666',
